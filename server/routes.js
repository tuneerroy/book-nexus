...
//   connection.query(`SELECT * FROM Songs WHERE album_id='${req.params.album_id}' ORDER BY number ASC`, (err, data) => {
//     if (err || data.length === 0) {
//       console.log(err);
//       res.json([]);
//     } else {
...
//     connection.query(`SELECT song_id, S.title, A.album_id, A.title AS album, plays, number, duration
...
//   if (!page) {
//     connection.query(`SELECT A.album_id, A.title, SUM(plays) AS plays FROM Albums A JOIN Songs S on A.album_id = S.album_id
//     GROUP BY A.album_id, title ORDER BY plays DESC;`, (err, data) => {
//       if (err || data.length === 0) {
//         console.log(err);
//         res.json([]);
//       }
...
//   } else {
//     connection.query(`SELECT A.album_id, A.title, SUM(plays) AS plays FROM Albums A JOIN Songs S on A.album_id = S.album_id
//     GROUP BY A.album_id, title ORDER BY plays DESC LIMIT ${pageSize} OFFSET ${(page - 1) * pageSize};`, (err, data) => {
//       if (err || data.length === 0) {
//         console.log(err);
//         res.json([]);
//       }
